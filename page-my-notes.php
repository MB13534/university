...
get_header();
  ...
  <div class="container container--narrow page-section">
    <div class="create-note">
      ...
      <span class="note-limit-message">Note limit reached: delete an existing note to make new for a new one. </span>
    </div>
    <ul>
          ...
          while($userNotes->have_posts()) {
            ...
            ?>
              <li data-id="<?php the_ID(); ?>">
                <input readonly class="note-title-field" type="text" value="<?php echo str_replace(
